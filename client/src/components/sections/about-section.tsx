...
export function AboutSection() {
  ...
  return (
    <section id="about" className="py-16" style={{ background: "linear-gradient(to bottom, #141414, #181818, #1a1a1a)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold mb-6 text-white">Our Vision: Democratizing AI's Transformative Power</h3>
        ...
        {/* Journey Section */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold mb-6 text-center text-white">Our Journey</h3>
          <p className="text-neutral-300 mb-8 max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-2 text-white">Web Development Excellence</h4>
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-2 text-white">Expanding Our Reach</h4>
              <p className="text-neutral-300">
